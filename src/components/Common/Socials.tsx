  ...
  return (
    <div>
      ...
      <a
        ...
        className="bg-gray-300 m-1 dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-full px-3 py-1 flex items-center space-x-2 transition-all duration-200 hover:bg-gray-400 dark:hover:bg-gray-600"
